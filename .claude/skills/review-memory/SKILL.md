...
```bash
python3 ~/.claude/skills/review-memory/scripts/export_memory.py <프로젝트경로> [출력디렉토리]
```
...
```bash
python3 ~/.claude/skills/review-memory/scripts/import_memory.py <아카이브.tar.gz> <대상프로젝트경로>
```
